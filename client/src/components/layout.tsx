...
import { QrCode, ArrowLeft, MessageSquare } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      {!isAi && (
        <Link href="/ai-assistant">
          <button 
            className="fixed bottom-6 left-6 z-50 bg-primary text-primary-foreground rounded-full p-4 shadow-2xl shadow-black/50 border-2 border-white/20 transition-transform active:scale-95 hover:scale-110 flex items-center gap-2 group"
