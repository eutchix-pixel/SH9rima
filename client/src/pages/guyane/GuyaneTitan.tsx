...
import {
  ...
  Shield, Rocket, Target, Zap, Settings,
...
const ACCENT = "#2a3f6b";
const ACCENT_DARK = "#141f38";
const ACCENT_LIGHT = "#5a7ab0";
const KRAFT = "#d4c5a0";
...
function SectionNumber({ num }: { num: number }) {
  return (
    <div className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-[#2a3f6b]/30 bg-[#2a3f6b]/5 shrink-0">
      <span className="text-sm font-bold text-[#2a3f6b]" style={{ fontFamily: "'IBM Plex Mono', monospace" }}>
...
const blocIcons = [Rocket, Target, Zap, Settings];
...
export default function GuyaneTitanPage() {
  ...
  useEffect(() => {
    ...
    Object.keys(quizRevealed).forEach(k => {
      const i = Number(k);
      if (quizRevealed[i] && quizAnswers[i] === guyaneTitanData.quiz[i].correctIndex) score++;
    });
    setQuizScore(score);
  ...
  return (
    <div className="min-h-screen relative" style={{ fontFamily: "'IBM Plex Mono', monospace", backgroundColor: KRAFT }}>
          ...
          >
            <div className="max-w-5xl mx-auto px-4 h-12 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] uppercase tracking-widest text-[#2a3f6b] font-bold">Titan</span>
              </div>
      ...
      <header className="relative overflow-hidden" style={{ background: `linear-gradient(180deg, #020610 0%, #0a1228 30%, #121e3a 55%, #1a2d50 70%, ${KRAFT} 100%)` }}>
        <div className="absolute inset-0 opacity-[0.06]" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Cline x1='50' y1='0' x2='50' y2='200' stroke='%235a7ab0' stroke-width='0.3'/%3E%3Ccircle cx='50' cy='30' r='3' fill='none' stroke='%235a7ab0' stroke-width='0.3'/%3E%3Ccircle cx='50' cy='170' r='8' fill='none' stroke='%235a7ab0' stroke-width='0.3'/%3E%3Cline x1='42' y1='170' x2='35' y2='200' stroke='%235a7ab0' stroke-width='0.2'/%3E%3Cline x1='58' y1='170' x2='65' y2='200' stroke='%235a7ab0' stroke-width='0.2'/%3E%3C/svg%3E")` }} />

        <div className="absolute top-10 right-10 w-[200px] h-[200px] opacity-[0.04]">
          <svg viewBox="0 0 200 200" fill="none" stroke="#5a7ab0" strokeWidth="0.8">
            <line x1="100" y1="20" x2="100" y2="180" />
            <circle cx="100" cy="20" r="6" />
            <path d="M85 180 L100 160 L115 180 Z" />
            <line x1="85" y1="180" x2="75" y2="200" />
            <line x1="115" y1="180" x2="125" y2="200" />
          </svg>
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-8 pb-24 md:pb-32">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-[1px] bg-[#5a7ab0]/40" />
              <span className="text-[10px] uppercase tracking-[0.5em] text-[#5a7ab0]/60">
                1968 — Aujourd'hui
              </span>
            </div>
            ...
            <p className="text-sm md:text-base text-[#a0b8d8]/60 leading-relaxed max-w-2xl">
              {guyaneTitanData.subtitle}
            </p>

            <motion.div
              className="relative pl-5 border-l-2 border-[#5a7ab0]/30 max-w-xl"
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.4, duration: 0.6 }}
            >
              <Rocket className="absolute -left-[13px] top-0 h-5 w-5 text-[#5a7ab0] bg-[#0a1228] p-0.5 rounded-full" />
              <p className="text-xs italic text-[#a0b8d8]/50 leading-relaxed pt-1">
                {guyaneTitanData.questionDirectrice}
              </p>
            </motion.div>
              ...
              {([
                ...
                <button
                  ...
                  className={`group relative px-5 py-3 rounded-lg transition-all duration-300 ${
                    readingMode === mode
                      ? 'bg-[#2a3f6b] shadow-lg shadow-[#2a3f6b]/20'
                      : 'bg-[#a0b8d8]/5 hover:bg-[#a0b8d8]/10 border border-[#a0b8d8]/10'
                  }`}
                  data-testid={`button-mode-${mode}`}
                >
                  <div className="flex items-center gap-2">
                    <Icon className={`h-3.5 w-3.5 ${readingMode === mode ? 'text-white' : 'text-[#5a7ab0]/60'}`} />
                    <span className={`text-xs font-medium ${readingMode === mode ? 'text-white' : 'text-[#a0b8d8]/70'}`}>
                      {label}
                    </span>
                  </div>
                  <span className={`text-[9px] mt-0.5 block ${readingMode === mode ? 'text-white/50' : 'text-[#a0b8d8]/30'}`}>
                    {sub}
                  </span>
                </button>
              ))}
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-20 relative z-10">
        ...
        <FadeInSection>
          <section className="relative" data-testid="bloc-reperes">
            <div className="flex items-start gap-4 p-6 md:p-8 rounded-xl bg-gradient-to-br from-[#2a3f6b]/8 to-[#2a3f6b]/3 border border-[#2a3f6b]/15">
              <div className="w-10 h-10 rounded-lg bg-[#2a3f6b]/10 flex items-center justify-center shrink-0">
                <Shield className="h-5 w-5 text-[#2a3f6b]" />
              </div>
              <div className="space-y-2">
                <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#2a3f6b]">
                  Repères
                </h3>
                <p className="text-xs leading-relaxed text-[#4a3b2a]/75">
                  {guyaneTitanData.reperes}
                </p>
              </div>
            </div>
          </section>
        ...
        <FadeInSection>
          <section className="relative" data-testid="bloc-resume">
            <div className="relative overflow-hidden rounded-xl shadow-2xl">
              <div className="absolute inset-0 bg-gradient-to-br from-[#020610] to-[#1a2d50]" />
              <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='1' fill='%235a7ab0'/%3E%3C/svg%3E")` }} />
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#5a7ab0] via-[#5a7ab0]/50 to-transparent" />
              <div className="relative z-10 p-8 md:p-12 space-y-6">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#5a7ab0]/10 flex items-center justify-center">
                    <Clock className="h-4 w-4 text-[#5a7ab0]" />
                  </div>
                  <div>
                    <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-[#e0e8f0]" style={{ fontFamily: "'Special Elite', cursive" }}>
                      Résumé
                    </h2>
                    <span className="text-[9px] text-[#5a7ab0]/50 uppercase tracking-widest">60 secondes de lecture</span>
                  </div>
                </div>
                <motion.div
                  className="w-16 h-[2px] rounded-full"
                  style={{ background: `linear-gradient(90deg, #5a7ab0, transparent)` }}
                  initial={{ scaleX: 0 }}
        ...
        <FadeInSection>
          <section className="space-y-8" data-testid="bloc-timeline">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-[#2a3f6b]/10 flex items-center justify-center">
                <Clock className="h-5 w-5 text-[#2a3f6b]" />
              </div>
              <div>
                <h2 className="text-xl md:text-2xl font-normal text-[#4a3b2a]" style={{ fontFamily: "'Special Elite', cursive" }}>
                  Chronologie
                </h2>
                <div className="w-12 h-[2px] bg-[#2a3f6b]/20 mt-1 rounded-full" />
              </div>
            </div>

            <div className="relative">
              <div className="absolute left-[19px] top-4 bottom-4 w-[2px] bg-gradient-to-b from-[#2a3f6b]/40 via-[#2a3f6b]/20 to-transparent" />
              <div className="space-y-3">
                {guyaneTitanData.timeline.map((event, i) => (
                  <motion.div
                    key={i}
                  ...
                  >
                    <div className="relative z-10 mt-4">
                      <div className="w-[10px] h-[10px] rounded-full bg-[#2a3f6b] ring-4 ring-[#d4c5a0] group-hover:ring-[#2a3f6b]/20 transition-all duration-300" />
                    </div>
                    <div className="flex-1 p-4 rounded-lg bg-white/40 border border-[#4a3b2a]/8 group-hover:bg-white/60 group-hover:border-[#2a3f6b]/15 group-hover:shadow-md transition-all duration-300">
                      <span className="text-[10px] font-bold text-[#2a3f6b] uppercase tracking-wider block mb-1">
                        {event.date}
                      </span>
        ...
        {guyaneTitanData.blocs.map((bloc, i) => {
              ...
              <section className="space-y-6" data-testid={`bloc-content-${i}`}>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <span className="text-[9px] font-bold uppercase tracking-[0.3em] text-[#2a3f6b]/50 block mb-1">
                      {blocLabels[i]}
                    </span>
                  ...
                  <BlocIcon className="h-5 w-5 text-[#2a3f6b]/30" />
                </div>

                {isHighlighted ? (
                  <div className="relative overflow-hidden rounded-xl shadow-2xl">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#2a3f6b] to-[#141f38]" />
                    ...
                    <div className="relative z-10 p-8 md:p-10 space-y-6">
                      ...
                      <div className="mt-6 p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
                        <div className="flex items-center gap-2">
                          <Lightbulb className="h-3.5 w-3.5 text-[#5a7ab0]" />
                          <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#5a7ab0]">
                            À retenir
                          </h4>
                        </div>
                        <ul className="space-y-2">
                          {bloc.aRetenir.map((item, j) => (
                            <li key={j} className="flex gap-3 text-xs text-white/70 leading-relaxed">
                              <Check className="h-3.5 w-3.5 shrink-0 text-[#5a7ab0] mt-0.5" />
                              <span>{item}</span>
                            </li>
                          ))}
                        </ul>
                  ...
                  <div className="space-y-5 pl-14">
                    ...
                    <div className="relative p-5 rounded-lg bg-gradient-to-r from-[#5a7ab0]/10 to-transparent border-l-[3px] border-[#2a3f6b]/30">
                      <div className="flex items-center gap-2 mb-3">
                        <Lightbulb className="h-3.5 w-3.5 text-[#2a3f6b]" />
                        <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#2a3f6b]">
                          À retenir
                        </h4>
                      </div>
                      <ul className="space-y-2">
                        {bloc.aRetenir.map((item, j) => (
                          <li key={j} className="flex gap-3 text-xs text-[#4a3b2a]/70 leading-relaxed">
                            <Check className="h-3.5 w-3.5 shrink-0 text-[#2a3f6b]/60 mt-0.5" />
                            <span>{item}</span>
                          </li>
                        ))}
                      </ul>
        ...
        {showRecit && (
          <FadeInSection>
            <section data-testid="bloc-glossaire">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#020610] to-[#1a2d50] rounded-xl" />
                <div className="relative z-10 p-6 md:p-8">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-[#5a7ab0]/10 flex items-center justify-center">
                        <BookMarked className="h-4 w-4 text-[#5a7ab0]" />
                      </div>
                      <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-[#e0e8f0]" style={{ fontFamily: "'Special Elite', cursive" }}>
                        Glossaire
                      </h2>
                      <span className="text-[9px] text-[#5a7ab0]/40 bg-[#5a7ab0]/5 px-2 py-0.5 rounded-full">
                        {guyaneTitanData.glossaire.length} termes
                      </span>
                    </div>
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <ChevronDown className="h-4 w-4 text-[#5a7ab0]/40 group-hover:text-[#5a7ab0] transition-colors" />
                    </motion.div>
                  </div>
                  ...
                  <AnimatePresence>
                    {glossaryOpen && (
                      ...
                      >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-6 mt-6 border-t border-[#5a7ab0]/10">
                          {guyaneTitanData.glossaire.map((entry, i) => (
                            <div
                              key={i}
                              className="p-3 rounded-lg bg-[#e0e8f0]/5 border border-[#e0e8f0]/5 hover:border-[#5a7ab0]/20 transition-colors"
                              data-testid={`glossaire-${i}`}
                            >
                              <span className="text-xs font-bold text-[#5a7ab0] block mb-1">
                                {entry.terme}
                              </span>
          ...
          <FadeInSection>
            <section className="space-y-8" data-testid="bloc-quiz">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-lg bg-[#2a3f6b]/10 flex items-center justify-center">
                    <HelpCircle className="h-5 w-5 text-[#2a3f6b]" />
                  </div>
                  <div>
                    <h2 className="text-xl md:text-2xl font-normal text-[#4a3b2a]" style={{ fontFamily: "'Special Elite', cursive" }}>
                      Mini‑Quiz
                ...
                <div className="flex items-center gap-2 bg-[#2a3f6b]/5 px-3 py-1.5 rounded-full">
                  <span className="text-[10px] font-bold text-[#2a3f6b]">
                    {quizScore}/{guyaneTitanData.quiz.length}
                  </span>
                  <div className="flex gap-0.5">
                    {guyaneTitanData.quiz.map((_, i) => (
                      <div
                        key={i}
                        className={`w-2 h-2 rounded-full transition-colors ${
                          quizRevealed[i]
                            ? quizAnswers[i] === guyaneTitanData.quiz[i].correctIndex
                              ? 'bg-[#2a3f6b]'
                              : 'bg-red-400'
                            : 'bg-[#4a3b2a]/15'
                        }`}
                  ...
                  >
                    {quizRevealed[i] && (
                      <div className={`absolute top-0 left-0 w-1 h-full ${
                        quizAnswers[i] === q.correctIndex ? 'bg-[#2a3f6b]' : 'bg-red-400'
                      }`} />
                    )}
                    <div className="p-5 space-y-4">
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left p-3 rounded-lg text-xs transition-all duration-200 border ${
                                revealed
                                  ? isCorrect
                                    ? 'bg-[#2a3f6b]/10 border-[#2a3f6b]/30 text-[#2a3f6b] font-medium'
                                    : isSelected
                                      ? 'bg-red-50 border-red-200 text-red-600 line-through'
                                      : 'bg-white/20 border-[#4a3b2a]/5 text-[#4a3b2a]/40'
                                  : isSelected
                                    ? 'bg-[#2a3f6b]/10 border-[#2a3f6b]/30 text-[#2a3f6b]'
                                    : 'bg-white/20 border-[#4a3b2a]/8 text-[#4a3b2a]/70 hover:bg-white/40 hover:border-[#2a3f6b]/15'
                              }`}
                      ...
                      {!quizRevealed[i] && quizAnswers[i] !== undefined && quizAnswers[i] !== null && (
                        <div className="pl-10">
                          <button
                            className="mt-1 text-[10px] uppercase tracking-wider text-[#2a3f6b] hover:text-[#2a3f6b]/80 font-bold transition-colors"
                      ...
                      {quizRevealed[i] && (
                        <motion.div
                          ...
                          transition={{ duration: 0.3 }}
                        >
                          <p className={`text-[10px] font-bold ${quizAnswers[i] === q.correctIndex ? 'text-[#2a3f6b]' : 'text-red-500'}`}>
