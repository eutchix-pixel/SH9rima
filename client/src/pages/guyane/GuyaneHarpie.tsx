              ...
              <div className="flex items-center gap-2">
                <Link href="/guyane/international">
                  <button className="text-[#4a3b2a]/60 hover:text-[#4a3b2a] transition-colors text-[10px] uppercase tracking-widest flex items-center gap-1" data-testid="sticky-link-back">
                    <ArrowLeft className="h-3 w-3" /> International
                  </button>
                </Link>
      ...
      <header className="relative overflow-hidden" style={{ background: `linear-gradient(180deg, #1a0e04 0%, #2a1808 30%, #3d2510 55%, #5c3a18 70%, ${KRAFT} 100%)` }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-8 pb-24 md:pb-32">
          <div className="flex justify-between items-center mb-16">
            <Link href="/guyane/international">
              <button className="text-[#d4c0a0]/50 hover:text-[#d4c0a0] transition-colors text-[10px] uppercase tracking-widest flex items-center gap-2" data-testid="link-back-international">
                <ArrowLeft className="h-3 w-3" /> International
              </button>
            </Link>
            <Link href="/#guyane">
              <button className="text-[#d4c0a0]/50 hover:text-[#d4c0a0] transition-colors text-[10px] uppercase tracking-widest" data-testid="link-back-guyane">
                Guyane
              </button>
            </Link>
          </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/guyane/international">
                  <Button
                    ...
                    data-testid="button-back-international"
                  >
                    <ArrowLeft className="mr-2 h-3.5 w-3.5" /> International
                  </Button>
                </Link>
                <Link href="/#guyane">
                  <Button
                ...
                <Link href="/#guyane">
                  <Button
                    className="bg-[#8b5e1a] text-white hover:bg-[#5c3a0d] px-6 py-5 text-xs rounded-lg shadow-lg shadow-[#8b5e1a]/20"
